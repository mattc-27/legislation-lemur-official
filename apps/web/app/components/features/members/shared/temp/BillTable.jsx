...
export default function BillTable({ groups = [], maxHeight = 520, selectedTopic }) {
    const rows = useMemo(() => {
        const out = [];
    ...
    return (
        <section className="billtable billtable--enriched">
...
function resolveLinks(it, billId) {
    ...
    console.log("[BillTable] appUrl:", appUrl, { memberId, memberName, billId });
