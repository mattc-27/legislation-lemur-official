    ...
    const headline = useMemo(() => {
        ...
        if (!b) {
            return covTone === "partial"
                ? `${a} is leading among classified bills this month.`
                : `${a} led introductions this month.`;
        }
                ...
                <div className="topic-spotlight">
                    {top3.length ? (
                        top3.map((t, idx) => {
                            ...
                            return (
                                <div
                                    key={t.policyAreaSlug ?? idx}
                                    className="topic-spot story-surface story-surface--soft"
                                >
