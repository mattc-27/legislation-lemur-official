...
export default function ReferencePage() {
  return (
    <main className="ll3-bills ll3-wk">
      {/* NEW: width + side padding wrapper */}
      <div className="ll3-wk__wrap">
        {/* HERO */}
        <header className="ll3-wk__hero">
          <div className="ll3-wk__heroTop">
            <span className="ll3-wk__pill">NONPARTISAN • OFFICIAL LINKS ONLY</span>
          ...
          <h1 className="ll3-wk__title">Voting Resources</h1>
        ...
        <section className="ll3-wk__steps" aria-label="Voting steps">
          {QUICK_LINKS.map((c) => (
            <article className="ll3-wk__card" key={c.title}>
              ...
              <a className="ll3-btn ll3-btn--open ll3-btn--full ll3-wk__cta" href={c.href} target="_blank" rel="noreferrer">
                {c.cta}
              </a>
            </article>
          ))}
        ...
        <section className="ll3-wk__panel" aria-labelledby="wk-lookup">
          ...
          <div className="ll3-wk__lookup">
            <div className="ll3-wk__selectWrap">
              <div className="ll3-field">
                <label className="ll3-label" htmlFor="state">
                  Choose your state or territory
                </label>
                <select id="state" className="ll3-input ll3-wk__select" defaultValue="">
            ...
            <div className="ll3-wk__lookupCards">
              <article className="ll3-wk__mini">
                ...
                <p className="ll3-wk__miniDesc">Official federal portal with your state’s registration and voting info.</p>
              ...
              <article className="ll3-wk__mini">
                ...
                <p className="ll3-wk__miniDesc">Find your state election office, official FAQs, and more details.</p>
        ...
        <section className="ll3-wk__wiki" aria-labelledby="wk-wiki">
          ...
          <div className="ll3-wk__wikiLayout">
            <nav className="ll3-wk__toc" aria-label="Table of contents">
              ...
              <a className="ll3-wk__tocLink" href="#committee-types">Committee types</a>
            ...
            <div className="ll3-wk__content">
              ...
              <article className="ll3-wk__panel">
                <Anchor id="committee-types">
                  <h3 className="ll3-wk__h3Big">Committee types (Standing, Select/Special, Joint)</h3>
                  <p className="ll3-wk__muted">
                  ...
                  <div className="ll3-wk__aboutGrid">
                    <div className="ll3-wk__faq">
                      <h3 className="ll3-wk__h3">Standing</h3>
                      <p className="ll3-wk__muted">
                    ...
                    <div className="ll3-wk__faq">
                      <h3 className="ll3-wk__h3">Select / Special</h3>
                      <p className="ll3-wk__muted">
                    ...
                    <div className="ll3-wk__faq">
                      <h3 className="ll3-wk__h3">Joint</h3>
                      <p className="ll3-wk__muted">
                  ...
                  <div className="ll3-wk__callout ll3-wk__callout--subtle">
                    <div className="ll3-wk__calloutTitle">Note</div>
                    <p className="ll3-wk__muted">
